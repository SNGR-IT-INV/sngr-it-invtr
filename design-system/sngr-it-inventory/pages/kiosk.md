...
- Full-screen, **no dashboard chrome** — no sidebar, no admin nav. This is a single-purpose terminal, not an admin surface. (`app/kiosk/in-log/new/page.tsx` intentionally sits outside the `(dashboard)` route group for this reason.)
