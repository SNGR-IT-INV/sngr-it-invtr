...
export type StorageHash =
  StorageHashBase<'407986d792ea9fd8ba25ac08f5ce64b01c433286834db8b49031d30fdcfc5efd'>;
...
export type FieldOutputTypes = {
  readonly public: {
    ...
    readonly EquipmentEvent: {
      ...
      readonly formSigned: CodecTypes['pg/bool@1']['output'];
      readonly createdAt: CodecTypes['pg/timestamptz-temporal@1']['output'];
    };
    readonly Staff: {
      readonly id: CodecTypes['pg/int4@1']['output'];
...
export type FieldInputTypes = {
  readonly public: {
    ...
    readonly EquipmentEvent: {
      ...
      readonly formSigned: CodecTypes['pg/bool@1']['input'];
      readonly createdAt: CodecTypes['pg/timestamptz-temporal@1']['input'];
    };
    readonly Staff: {
      readonly id: CodecTypes['pg/int4@1']['input'];
          ...
          readonly table: {
            ...
            readonly equipmentEvent: {
              ...
              indexes: readonly [
                ...
                {
                  readonly name: 'equipmentEvent_ticketNumber_idx_934212c9';
                  readonly prefix: 'equipmentEvent_ticketNumber_idx';
                  readonly columns: readonly ['ticketNumber'];
                  readonly unique: false;
                },
                {
                  readonly name: 'equipmentEvent_processedById_idx_92dfd8d4';
                  readonly prefix: 'equipmentEvent_processedById_idx';
                  readonly columns: readonly ['processedById'];
                  readonly unique: false;
                },
                {
                  readonly name: 'equipmentEvent_counterpartyId_idx_d3c53383';
                  readonly prefix: 'equipmentEvent_counterpartyId_idx';
          ...
          readonly EquipmentEvent: {
            ...
            readonly storage: {
              ...
              readonly fields: {
                ...
                readonly formSigned: { readonly column: 'formSigned' };
                readonly createdAt: { readonly column: 'createdAt' };
              };
            };
          };
