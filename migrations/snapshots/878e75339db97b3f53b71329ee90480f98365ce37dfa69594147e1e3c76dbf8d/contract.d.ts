...
export type StorageHash =
  StorageHashBase<'878e75339db97b3f53b71329ee90480f98365ce37dfa69594147e1e3c76dbf8d'>;
  ...
  readonly public: {
    ...
    readonly EquipmentEvent: {
      ...
      readonly returnReason:
        'loa' | 'resignation' | 'e_waste' | 'role_change' | 'replacement' | 'other' | null;
      readonly returnReasonNote: CodecTypes['pg/text@1']['output'] | null;
      readonly ticketNumber: CodecTypes['pg/text@1']['output'] | null;
      readonly quoteNumber: CodecTypes['pg/text@1']['output'] | null;
      readonly intendedForId: CodecTypes['pg/int4@1']['output'] | null;
      readonly createdAt: CodecTypes['pg/timestamptz-string@1']['output'];
    };
...
export type FieldInputTypes = {
  readonly public: {
    ...
    readonly EquipmentEvent: {
      ...
      readonly returnReason:
        'loa' | 'resignation' | 'e_waste' | 'role_change' | 'replacement' | 'other' | null;
      readonly returnReasonNote: CodecTypes['pg/text@1']['input'] | null;
      readonly ticketNumber: CodecTypes['pg/text@1']['input'] | null;
      readonly quoteNumber: CodecTypes['pg/text@1']['input'] | null;
      readonly intendedForId: CodecTypes['pg/int4@1']['input'] | null;
      readonly createdAt: CodecTypes['pg/timestamptz-string@1']['input'];
    };
    readonly EquipmentVisit: {
      readonly id: CodecTypes['pg/int4@1']['input'];
      ...
      readonly public: {
        ...
        readonly entries: {
          readonly table: {
            ...
            readonly equipmentEvent: {
              ...
              indexes: readonly [
                ...
                {
                  readonly name: 'equipmentEvent_intendedForId_idx_53db83a1';
                  readonly prefix: 'equipmentEvent_intendedForId_idx';
                  readonly columns: readonly ['intendedForId'];
                  readonly unique: false;
                },
              ];
              foreignKeys: readonly [
          ...
          readonly valueSet: {
            ...
            readonly EquipmentReturnReason: {
              readonly kind: 'valueSet';
      ...
      readonly public: {
          ...
          readonly EquipmentEvent: {
            ...
            readonly relations: {
              ...
              readonly intendedFor: {
                ...
                readonly cardinality: 'N:1';
                readonly on: {
                  readonly localFields: readonly ['intendedForId'];
                  readonly targetFields: readonly ['id'];
                };
              };
              readonly visit: {
            ...
            readonly storage: {
              ...
              readonly fields: {
                ...
                readonly returnReasonNote: { readonly column: 'returnReasonNote' };
                readonly ticketNumber: { readonly column: 'ticketNumber' };
                readonly quoteNumber: { readonly column: 'quoteNumber' };
                readonly intendedForId: { readonly column: 'intendedForId' };
                readonly createdAt: { readonly column: 'createdAt' };
              };
            };
          };
          ...
          readonly Staff: {
            ...
            readonly relations: {
              ...
              readonly intendedForEvents: {
                ...
                readonly on: {
                  readonly localFields: readonly ['id'];
                  readonly targetFields: readonly ['intendedForId'];
                };
              };
        ...
        readonly enum: {
          ...
          readonly EquipmentReturnReason: {
            readonly codecId: 'pg/text@1';
            readonly members: readonly [
              { readonly name: 'loa'; readonly value: 'loa' },
              { readonly name: 'resignation'; readonly value: 'resignation' },
